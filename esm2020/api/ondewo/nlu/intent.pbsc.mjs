        ...
        this.$raw = {
            ...
            tagIntent: (requestData, requestMetadata = new GrpcMetadata()) => {
                return this.handler.handle({
                    ...
                    requestData,
                    requestMetadata,
                    requestClass: thisProto.IntentTagMessage,
                    responseClass: googleProtobuf003.Empty
                });
            },
            /**
