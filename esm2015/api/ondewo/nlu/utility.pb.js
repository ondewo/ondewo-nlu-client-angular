...
export class ValidateEmbeddedRegexRequest {
    ...
    constructor(_value) {
        ...
        this.entityType = _value.entityType
            ? new ondewoNlu008.EntityType.Entity(_value.entityType)
            : undefined;
    ...
    static deserializeBinaryFromReader(_instance, _reader) {
        while (_reader.nextField()) {
            ...
            switch (_reader.getFieldNumber()) {
                case 1:
                    _instance.entityType = new ondewoNlu008.EntityType.Entity();
                    _reader.readMessage(_instance.entityType, ondewoNlu008.EntityType.Entity.deserializeBinaryFromReader);
                    break;
                default:
                    _reader.skipField();
            }
    ...
    static serializeBinaryToWriter(_instance, _writer) {
        if (_instance.entityType) {
            _writer.writeMessage(1, _instance.entityType, ondewoNlu008.EntityType.Entity.serializeBinaryToWriter);
        }
    }
    get entityType() {
...
export class CleanAllIntentsResponse {
    ...
    constructor(_value) {
        _value = _value || {};
        this.cleanedIntents = (_value.cleanedIntents || []).map(m => new ondewoNlu007.Intent(m));
    ...
    static deserializeBinaryFromReader(_instance, _reader) {
        while (_reader.nextField()) {
            ...
            switch (_reader.getFieldNumber()) {
                case 1:
                    const messageInitializer1 = new ondewoNlu007.Intent();
                    _reader.readMessage(messageInitializer1, ondewoNlu007.Intent.deserializeBinaryFromReader);
    ...
    static serializeBinaryToWriter(_instance, _writer) {
        if (_instance.cleanedIntents && _instance.cleanedIntents.length) {
            _writer.writeRepeatedMessage(1, _instance.cleanedIntents, ondewoNlu007.Intent.serializeBinaryToWriter);
        }
...
export class CleanIntentResponse {
    ...
    constructor(_value) {
        ...
        this.cleanedIntent = _value.cleanedIntent
            ? new ondewoNlu007.Intent(_value.cleanedIntent)
            : undefined;
    ...
    static deserializeBinaryFromReader(_instance, _reader) {
        while (_reader.nextField()) {
            ...
            switch (_reader.getFieldNumber()) {
                case 1:
                    _instance.cleanedIntent = new ondewoNlu007.Intent();
                    _reader.readMessage(_instance.cleanedIntent, ondewoNlu007.Intent.deserializeBinaryFromReader);
                    break;
                case 2:
    ...
    static serializeBinaryToWriter(_instance, _writer) {
        if (_instance.cleanedIntent) {
            _writer.writeMessage(1, _instance.cleanedIntent, ondewoNlu007.Intent.serializeBinaryToWriter);
        }
...
export class CleanAllEntityTypesResponse {
    ...
    constructor(_value) {
        _value = _value || {};
        this.cleanedEntityTypes = (_value.cleanedEntityTypes || []).map(m => new ondewoNlu008.EntityType(m));
        this.deletedEntityTypes = (_value.deletedEntityTypes || []).map(m => new ondewoNlu008.EntityType(m));
    ...
    static deserializeBinaryFromReader(_instance, _reader) {
        while (_reader.nextField()) {
            ...
            switch (_reader.getFieldNumber()) {
                case 1:
                    const messageInitializer1 = new ondewoNlu008.EntityType();
                    _reader.readMessage(messageInitializer1, ondewoNlu008.EntityType.deserializeBinaryFromReader);
                    (_instance.cleanedEntityTypes =
                        _instance.cleanedEntityTypes || []).push(messageInitializer1);
                    break;
                case 2:
                    const messageInitializer2 = new ondewoNlu008.EntityType();
                    _reader.readMessage(messageInitializer2, ondewoNlu008.EntityType.deserializeBinaryFromReader);
    ...
    static serializeBinaryToWriter(_instance, _writer) {
        if (_instance.cleanedEntityTypes && _instance.cleanedEntityTypes.length) {
            _writer.writeRepeatedMessage(1, _instance.cleanedEntityTypes, ondewoNlu008.EntityType.serializeBinaryToWriter);
        }
        if (_instance.deletedEntityTypes && _instance.deletedEntityTypes.length) {
            _writer.writeRepeatedMessage(2, _instance.deletedEntityTypes, ondewoNlu008.EntityType.serializeBinaryToWriter);
        }
...
export class CleanEntityTypeResponse {
    ...
    constructor(_value) {
        ...
        this.cleanedEntityType = _value.cleanedEntityType
            ? new ondewoNlu008.EntityType(_value.cleanedEntityType)
            : undefined;
    ...
    static deserializeBinaryFromReader(_instance, _reader) {
        while (_reader.nextField()) {
            ...
            switch (_reader.getFieldNumber()) {
                case 1:
                    _instance.cleanedEntityType = new ondewoNlu008.EntityType();
                    _reader.readMessage(_instance.cleanedEntityType, ondewoNlu008.EntityType.deserializeBinaryFromReader);
                    break;
                case 2:
    ...
    static serializeBinaryToWriter(_instance, _writer) {
        if (_instance.cleanedEntityType) {
            _writer.writeMessage(1, _instance.cleanedEntityType, ondewoNlu008.EntityType.serializeBinaryToWriter);
        }
...
(function (AddTrainingPhrasesRequest) {
    ...
    class TrainingPhraseForIntent {
        ...
        constructor(_value) {
            ...
            this.intentDisplayName = _value.intentDisplayName;
            this.entities = (_value.entities || []).map(m => new ondewoNlu007.Intent.TrainingPhrase.Entity(m));
            ...
            while (_reader.nextField()) {
                ...
                switch (_reader.getFieldNumber()) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        const messageInitializer3 = new ondewoNlu007.Intent.TrainingPhrase.Entity();
                        _reader.readMessage(messageInitializer3, ondewoNlu007.Intent.TrainingPhrase.Entity
                            .deserializeBinaryFromReader);
        ...
        static serializeBinaryToWriter(_instance, _writer) {
            ...
            if (_instance.entities && _instance.entities.length) {
                _writer.writeRepeatedMessage(3, _instance.entities, ondewoNlu007.Intent.TrainingPhrase.Entity.serializeBinaryToWriter);
            }
        }
        get trainingPhrase() {
...
//# sourceMappingURL=data:application/json;base64,